...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <properties>
        ...
        <!-- FIT version -->
        <fit.version>3.6.1-SNAPSHOT</fit.version>
...
```
Running command: java -D"plugin.fit.dynamic.plugin.directory=/d/WorkSpace/custom" -jar fit-discrete-launcher-3.6.1-SNAPSHOT.jar
